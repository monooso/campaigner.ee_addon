...
/**
 * Abstract API connector. All API connector implementations should extend this class.
 *
...
require_once dirname(__FILE__) .DIRECTORY_SEPARATOR .'campaigner_subscriber' .EXT;
...
abstract class Campaigner_api_connector {
	 ...
	 * @return	bool
	 */
	abstract public function add_list_subscriber($list_id, Campaigner_subscriber $subscriber, $resubscribe = FALSE);
	 ...
	 * @return	array
	 */
	abstract public function get_client_lists($client_id, $include_fields = FALSE);
